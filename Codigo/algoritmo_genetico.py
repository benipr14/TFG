...
TASA_CRUZAMIENTO = 1 #float(sys.argv[3])
#TASA_MUTACION = 0.2
INDPB_MUTACION = 1 / 48
TAMANO_TORNEO = 3
...
def evaluar_vector(vector_coeficientes):
    calcula_zonas.zonas_coeficientes = vector_coeficientes
    total_aciertos = 0
...
toolbox.register("individual", tools.initRepeat, creator.Individual, toolbox.attr_float, n=48)
...
def algoritmo_genetico():
    ...
    for gen in range(NUM_GENERACIONES):
        ...
        elite = tools.selBest(poblacion, k=1)  # Preservar los 4 mejores individuos
